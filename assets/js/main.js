...
(() => {
  ...
  const IMAGES = {
    beans: 'assets/img/beans-user.webp',
    brewing: 'assets/img/brewing-user.webp',
    space: 'assets/img/space-user.webp'
  };
...
// Dish images: add zoomable class
(() => {
  document.querySelectorAll('.dish-media img').forEach((img) => img.classList.add('zoomable'));
})();
